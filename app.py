...
def render_disclaimer_consent(section_type):
    """Render disclaimer with consent checkbox for Advice and Rebalance sections"""
    st.markdown("### Disclaimer – Investment Advice & Portfolio Rebalancing")
...
"""
    ...
    if agree_checkbox:
        if st.button("I Agree - Proceed to " + ("Investment Advice" if section_type == 'advice' else "Portfolio Rebalancing"), type="primary", key=f"agree_btn_{section_type}"):
            st.session_state.disclaimer_accepted = True
            st.rerun()
    else:
        st.info("Please read the disclaimer and check the box to proceed.")
...
def display_analysis():
    ...
    with tab5:
        if st.session_state.get('disclaimer_accepted', False):
            ...
            render_disclaimer_consent('advice')
    ...
    with tab6:
        if st.session_state.get('disclaimer_accepted', False):
            ...
            render_disclaimer_consent('rebalance')
