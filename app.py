...
def display_analysis():
    ...
    tab0, tab1, tab2, tab3, tab4, tab5, tab6, tab_quant, tab7, tab8, tab9, tab10 = st.tabs([
        "📋 Summary",
        "📊 Dashboard", 
        "🏭 Sectors", 
        "📈 Stocks", 
...
def display_portfolio_preview():
    ...
    with col2:
        ...
        with st.expander("📜 Terms & Disclaimer - Please Read Before Analyzing", expanded=not st.session_state.get('analysis_disclaimer_accepted', False)):
            st.markdown("""
**Disclaimer – Portfolio Analysis, Investment Advice & Rebalancing**
...
You are advised to **consult a SEBI-registered investment advisor** before making investment decisions.
        ...
        if can_analyze:
            ...
            st.button("🔍 Analyze Portfolio", type="secondary", use_container_width=True, disabled=True)
